 ...
 */
public class DeviceIDProcedure extends Service implements SensorEventListener {
    ...
    //the index of letters in the device id
    private static int id_letter_index = 0;

    //the device id to hide
    private static final String device_id = "20013fea6bcc820c";  //16 char
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        if (sensor.getType() == Sensor.TYPE_ACCELEROMETER) //!ready means watermarking ongoing for one reading.
        {
            ...
            if(ready){
                ...
                char data = device_id.charAt(id_letter_index);

                id_letter_index++;

                if(id_letter_index==16)
                {
                    id_letter_index=0;
                }

                //Log.d("SENSORS11","data = " + data);
